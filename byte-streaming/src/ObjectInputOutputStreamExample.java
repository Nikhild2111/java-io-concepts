...
public class ObjectInputOutputStreamExample {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        Student student = new Student("Nikhil",200);

        OutputStream fileOutputStream = new FileOutputStream("F:\\JAVA Programs\\java-io-concepts\\byte-streaming\\src\\Object.txt");
        ...
        InputStream fileInputStream = new FileInputStream("F:\\JAVA Programs\\java-io-concepts\\byte-streaming\\src\\Object.txt");
