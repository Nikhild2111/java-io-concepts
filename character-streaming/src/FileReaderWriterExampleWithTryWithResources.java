...
public class FileReaderWriterExampleWithTryWithResources {
    public static void main(String[] args) throws IOException {
        ...
        try(Reader fileReader = new FileReader("F:\\JAVA Programs\\java-io-concepts\\character-streaming\\src\\input.txt");){
            ...
            try(Writer fileWriter = new FileWriter("F:\\JAVA Programs\\java-io-concepts\\character-streaming\\src\\output.txt");
            ){
