...
public class BufferedReaderWriterExample {
    public static void main(String[] args) throws IOException {
        ...
        try (    //file reader
                 FileReader fileReader = new FileReader("F:\\JAVA Programs\\java-io-concepts\\character-streaming\\src\\input.txt");
                 //buffer reader
            ...
            try (
                    //file writer
                    FileWriter fileWriter = new FileWriter("F:\\JAVA Programs\\java-io-concepts\\character-streaming\\src\\output.txt");
                    //buffer writer
