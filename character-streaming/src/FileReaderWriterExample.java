...
public class FileReaderWriterExample {
    public static void main(String[] args) throws IOException {
        ...
        Reader fileReader = new FileReader("F:\\JAVA Programs\\java-io-concepts\\character-streaming\\src\\input.txt");
        ...
        Writer fileWriter = new FileWriter("F:\\JAVA Programs\\java-io-concepts\\character-streaming\\src\\output.txt");
