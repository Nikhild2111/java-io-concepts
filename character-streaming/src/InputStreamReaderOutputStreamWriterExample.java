...
public class InputStreamReaderOutputStreamWriterExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try ( //fileInputStream
              FileInputStream fileInputStream = new FileInputStream("F:\\JAVA Programs\\java-io-concepts\\character-streaming\\src\\input.txt");
            ...
            try (  //fileOutputStream
                   FileOutputStream fileOutputStream = new FileOutputStream("F:\\JAVA Programs\\java-io-concepts\\character-streaming\\src\\output.txt");
